...
if(!PlayFab.settings) {
    PlayFab.settings = {
        titleId: "859F4", // You must set this value for PlayFabSdk to work properly (Found in the Game Manager for your title, at the PlayFab Website)
        developerSecretKey: "KTAIP37FM89AF96YJKRH4GIGT6GPQDTIE65IU5N8Y7G4Z66F1X", // For security reasons you must never expose this value to the client or players - You must set this value for Server-APIs to work properly (Found in the Game Manager for your title, at the PlayFab Website)
        GlobalHeaderInjection: null,
        productionServerUrl: "859F4.playfabapi.com"
    }
}
...
if(!PlayFab._internalSettings) {
    PlayFab._internalSettings = {
        entityToken: null,
        sdkVersion: "1.145.230529",
        requestGetParams: {
            sdk: "JavaScriptSDK-1.145.230529"
        },
        sessionTicket: null,
...
PlayFab.sdkVersion = "1.145.230529";
